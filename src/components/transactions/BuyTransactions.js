...
class BuyTransactions extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        var list = transactions.filter(x => x.type === 'buy').map(function (items, index) {
            return (
                <tr key={index}>
...
export default connect(mapStateToProps)(BuyTransactions);