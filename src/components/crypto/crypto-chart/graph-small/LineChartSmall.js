...
class LineChartSmall extends Component {
    constructor(props) {
        super(props);
        this.state = {
            hoverLoc: null,
    ...
    makePath() {
        ...
        return (
            <path className="linechart_path-small" d={pathD} style={{ stroke: color }} />
        );
    }
    // BUILD SHADED AREA
    makeArea() {
        ...
        return <path className="linechart_area-small" d={pathD} />
    }
    // BUILD GRID AXIS
    makeAxis() {
        ...
        return (
            <g className="linechart_axis-small">
                <line
    ...
    makeLabels() {
        ...
        const padding = 5;
        return (
            <g className="linechart_label-small">
                {/* Y AXIS LABELS */}
    ...
    makeActivePoint() {
        ...
        return (
            <circle
                className='linechart_point-small'
                style={{ stroke: color }}
                r={pointRadius}
    ...
    createLine() {
        const { svgHeight, xLabelSize } = this.props;
        return (
            <line className='hoverLine-small'
    ...
    render() {
        ...
        return (
            <svg width={svgWidth} height={svgHeight} viewBox={`0 0 ${svgWidth} ${svgHeight}`} className={'linechart-small'}
